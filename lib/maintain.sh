#!/bin/bash
# ============================================================
# 起易蝦 Maintenance Functions (shared by Mac menus)
...
do_uninstall() {
    ...
    case $MODE in
        ...
        portable)
            ...
            echo ""
            echo "  Electron 桌面版卸载:"
            echo "    macOS: 将 起易蝦.app 从「应用程序」拖到废纸篓"
            ;;
    esac
}
...
do_plugins() {
    ...
    case $PLG_CHOICE in
        ...
        b)
            ...
            echo "    @openclaw/telegram           — Telegram"
            echo "    @openclaw/discord            — Discord"
            echo ""
